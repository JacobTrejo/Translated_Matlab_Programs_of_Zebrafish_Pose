...
from Translated_Python_Programs import eye1model
import matplotlib.pyplot as plt


outputMat = loadmat('../Matlab_Data/eye1ModelMatlabOutput.mat')
outputArr = outputMat['matlabOutput']

dataMat = loadmat('../Matlab_Data/eye1ModelRandomData.mat')
...
while count < 1000:
    ...
    pythonOutput = eye1model.eye1model(dataArr[0,y], dataArr[0, y + 1], dataArr[0, y + 2], dataArr[0, y + 3], dataArr[0, y + 4], dataArr[0, y + 5], np.array([dataArr[0, y + 6], dataArr[0, y + 7], dataArr[0, y + 8], dataArr[0, y + 9]]))
...
plt.ylabel('Amount')
plt.xlabel('Eye1 Model Error')
plt.xlim(xmin = -2 * (10 ** -16) - (10 ** -17), xmax = 2 * (10 ** -16) - (10 ** -17))
plt.axvline(x.mean(), color='k', linestyle='dashed', linewidth=1)
plt.title("Eye1 Model Error Distribution")
plt.show()
