...
import numpy as np
from Translated_Python_Programs import gen_lut_s_tail
...
def view_s_lut_new_real_cpu(crop_coor, pt,lut,projection,imageSizeX,imageSizeY):
...
if 0:
    ...
    a = view_s_lut_new_real_cpu(crop_coor,pt,1,proj,imageSizeX,imageSizeY)
