...
def view_b_lut_new_real_cpu(crop_coor, pt, lut_tail, projection, imageSizeX, imageSizeY,r1,r2):
    ...
    for ni in range(0,7):
        ...
        tail_model = gen_lut_b_tail_no_random.gen_lut_b_tail(ni + 1, seglenidx[newIndex], dt[0, n], dt[1, n], at[0,n], r1)
        # tail_model = gen_lut_b_tail_no_random.gen_lut_b_tail(ni + 1, seglenidx[n], dt[0, n], dt[1, n], at[0,n], r1)
...
if 1:
    ...
    a = view_b_lut_new_real_cpu(crop_coor,pt,1,proj,imageSizeX,imageSizeY,.3,.2)
