...
from Translated_Python_Programs import calc_proj_w_refra_cpu_v3, eye1model, eye2model, project_camera_copy, \
    reorient_model

from Translated_Python_Programs_Without_Randoms import bellymodelNoRandom, headmodelNoRandom


def return_head_real_model_new(x,fishlen,proj_params,cb,cs1,cs2,r1,r2,r3,r4,r5):
    ...
    belly_model = bellymodelNoRandom.bellymodel(x_c, y_c, z_c, seglen, belly_br, size_lut_3d, r1, r2, r3, r4, r5)

    head_model = headmodelNoRandom.headmodel(x_c, y_c, z_c, seglen, head_br, size_lut_3d, r1, r2, r3, r4)
...
if 0:
    ...
    "proj_params_101019_corrected_new"
    ...
    (b, x, y, z, q) = return_head_real_model_new(x,1,"proj_params_101019_corrected_new",cb,cs1,cs2,.5,.6,.55,.43,.32)
    print(b.shape)